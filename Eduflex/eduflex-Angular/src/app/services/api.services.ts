...
export class Client {
     ...
     * @return OK
     */
    studentApplication(studentId: string): Observable<ApplicationDto[]> {
        let url_ = this.baseUrl + "/api/Applications/student-application/{studentId}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processStudentApplication(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processStudentApplication(response_ as any);
                } catch (e) {
    ...
    protected processStudentApplication(response: HttpResponseBase): Observable<ApplicationDto[]> {
